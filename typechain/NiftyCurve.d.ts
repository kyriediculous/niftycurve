...
interface NiftyCurveInterface extends ethers.utils.Interface {
  functions: {
...
export class NiftyCurve extends Contract {
  ...
  interface: NiftyCurveInterface;

  functions: {
    NFT(overrides?: CallOverrides): Promise<[string, BigNumber]>;
